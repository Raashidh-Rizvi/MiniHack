              ...
              >
                ...
                <div className="flex items-center space-x-2 pt-3 md:pt-0 border-t md:border-t-0 border-slate-100 dark:border-white/5 justify-end">
                  ...
                  <button
                    ...
                    className="inline-flex items-center space-x-1.5 px-3 py-1.5 rounded-xl text-xs font-semibold liquid-btn-glass"
                  >
                  ...
                  <button
                    ...
                    disabled={['RESOLVED', 'DUPLICATE', 'REJECTED'].includes(report.status)}
                    className="inline-flex items-center space-x-1.5 px-3 py-1.5 rounded-xl text-xs font-semibold liquid-btn-danger"
                  >
          ...
          >
            ...
            <div className="flex space-x-3">
              <button
                type="button"
                onClick={() => setCancelModalOpen(false)}
                className="flex-1 py-2.5 rounded-xl text-xs font-semibold liquid-btn-glass"
              >
                Keep Report
              </button>
              <button
                ...
                className="flex-1 py-2.5 rounded-xl text-xs font-semibold liquid-btn-danger"
              >
                Yes, Cancel
              </button>
            </div>
